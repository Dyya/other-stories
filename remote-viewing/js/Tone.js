    ...
    var t = {
                    ...
                    if (null != s) {
                        ...
                        try {
                            if (o = (s = s.call(t)).next, 0 === e) {
                                ...
                                for (; !(c = (n = o.call(s)).done) && (a.push(n.value), a.length !== e); c = !0);
                        } catch (t) {
                            h = !0, i = t
                        } finally {
                            try {
            ...
            564: t => {
                function e(s) {
                    ...
                    }, t.exports.__esModule = !0, t.exports.default = t.exports, e(s)
                }
                ...
                ! function(t, e, s, n) {
                    ...
                    var i = function(t, e, s) {
                        ...
                        f = function t(e, s, n, i) {
                            var o = e[s];
                            return void 0 === o ? i : u(o) || p(o) ? o.value : d(o) ? o.values[o.values.length - 1] : c(n, t(e, s - 1, o.startTime, i), o)
                        },
                        _ = function(t, e, s, n, i) {
                            return void 0 === s ? [n.insertTime, i] : u(s) ? [s.endTime, s.value] : p(s) ? [s.startTime, s.value] : d(s) ? [s.startTime + s.duration, s.values[s.values.length - 1]] : [s.startTime, f(t, e - 1, s.startTime, i)]
                        },
                        m = function(t) {
                        ...
                        v = function(t) {
                            return m(t) || g(t) ? t.cancelTime : h(t) || l(t) ? t.endTime : t.startTime
                        },
                        y = function(t, e, s, n) {
                            var i = n.endTime,
                                o = n.value;
                            ...
                            return n((function t(e) {
                                ...
                                value: function(t) {
                                    ...
                                    if (m(t) || g(t)) {
                                        var s = this._automationEvents.findIndex((function(s) {
                                                return g(t) && d(s) ? s.startTime + s.duration >= e : v(s) >= e
                                            })),
                                            n = this._automationEvents[s];
                                        if (-1 !== s && (this._automationEvents = this._automationEvents.slice(0, s)), m(t)) {
                                            var c = this._automationEvents[this._automationEvents.length - 1];
                                            if (void 0 !== n && u(n)) {
                                                if (void 0 !== c && b(c)) throw new Error("The internal list is malformed.");
                                                var p = void 0 === c ? n.insertTime : d(c) ? c.startTime + c.duration : v(c),
                                                    f = void 0 === c ? this._defaultValue : d(c) ? c.values[c.values.length - 1] : c.value,
                                                    _ = h(n) ? y(e, p, f, n) : x(e, p, f, n),
                                                    w = h(n) ? i(_, e, this._currenTime) : o(_, e, this._currenTime);
                                                this._automationEvents.push(w)
                                            }
                                            if (void 0 !== c && b(c) && this._automationEvents.push(r(this.getValue(e), e)), void 0 !== c && d(c) && c.startTime + c.duration > e) {
                                                var T = e - c.startTime,
                                                    S = (c.values.length - 1) / c.duration,
                                                    k = Math.max(2, 1 + Math.ceil(T * S)),
                                                    A = T / (k - 1) * S,
                                                    C = c.values.slice(0, k);
                                                if (A < 1)
                                                    for (var O = 1; O < k; O += 1) {
                                                        var D = A * O % 1;
                                        ...
                                        if (void 0 !== E && d(E) && v(E) + E.duration > e) return !1;
                                        var R = h(t) ? i(t.value, t.endTime, this._currenTime) : l(t) ? o(t.value, e, this._currenTime) : t;
                                        if (-1 === M) this._automationEvents.push(R);
                                        else {
                                            if (d(t) && e + t.duration > v(this._automationEvents[M])) return !1;
                                ...
                                value: function(t) {
                                    ...
                                    if (e > 1) {
                                        var s = this._automationEvents.slice(e - 1),
                                            n = s[0];
                                        b(n) && s.unshift(r(f(this._automationEvents, e - 2, n.startTime, this._defaultValue), n.startTime)), this._automationEvents = s
                                    }
                                }
                            }, {
                                key: "getValue",
                                value: function(t) {
                                    ...
                                    var s = this._automationEvents.findIndex((function(e) {
                                        ...
                                        n = this._automationEvents[s],
                                        i = (-1 === s ? this._automationEvents.length : s) - 1,
                                        o = this._automationEvents[i];
                                    if (void 0 !== o && b(o) && (void 0 === n || !u(n) || n.insertTime > t)) return c(t, f(this._automationEvents, i - 1, o.startTime, this._defaultValue), o);
                                    if (void 0 !== o && p(o) && (void 0 === n || !u(n))) return o.value;
                                    if (void 0 !== o && d(o) && (void 0 === n || !u(n) || o.startTime + o.duration > t)) return t < o.startTime + o.duration ? w(t, o) : o.values[o.values.length - 1];
                                    if (void 0 !== o && u(o) && (void 0 === n || !u(n))) return o.value;
                                    if (void 0 !== n && h(n)) {
                                        var r = _(this._automationEvents, i, o, n, this._defaultValue),
                                            a = e(r, 2),
                                            m = a[0],
                                            g = a[1];
                                        return y(t, m, g, n)
                                    ...
                                    if (void 0 !== n && l(n)) {
                                        var T = _(this._automationEvents, i, o, n, this._defaultValue),
                                            S = e(T, 2),
                                            k = S[0],
                                            A = S[1];
                                        return x(t, k, A, n)
    ...
    return (() => {
        ...
        const r = new WeakSet,
            ...
            ct = (t, e, s, n, i) => {
                const [o, r] = ((t, e, s, n) => {
                    ...
                    return null === r ? [T(o, t, s, n)[2], !1] : [r[2], !0]
                })(t, s, n, i);
            ...
            ht = (t, e, s, n) => {
                const [i, o] = ((t, e, s) => {
                    ...
                    return null === o ? [J(i, t, s)[1], !1] : [o[2], !0]
                })(t, s, n);
        ...
        const dt = (t, e, s, n, i) => {
            ...
            _t = async (t, e, s, n, i, o, r) => {
                ...
                channelInterpretation: "speakers",
                gain: 1
            }, At = () => new DOMException("", "InvalidStateError"), Ct = () => new DOMException("", "InvalidAccessError"), Ot = {
                channelCount: 2,
                channelCountMode: "max",
                channelInterpretation: "speakers"
            }, Dt = (t, e, s, n, i, o, r, a, c, h, l) => {
                const u = h.length;
                let p = a;
                for (let a = 0; a < u; a += 1) {
                    let u = s[0] * h[a];
        ...
        const Ce = (t => null === t ? null : t.hasOwnProperty("OfflineAudioContext") ? t.OfflineAudioContext : t.hasOwnProperty("webkitOfflineAudioContext") ? t.webkitOfflineAudioContext : null)(xe),
            Oe = (t => e => null !== t && e instanceof t)(Ce),
            De = new WeakMap,
            Me = (t => class {
                constructor(t) {
            ...
            Ie = (t => e => null !== t && "function" == typeof t.AudioParam && e instanceof t.AudioParam)(xe),
            Fe = (t => null === t ? null : t.hasOwnProperty("AudioWorkletNode") ? t.AudioWorkletNode : null)(xe),
                ...
                const v = _.value,
                    ...
                    w = {
                        ...
                        cancelAndHoldAtTime(t) {
                            if ("function" == typeof _.cancelAndHoldAtTime) null === x && y.flush(n.context.currentTime), y.add(i(t)), _.cancelAndHoldAtTime(t);
                            else {
                        ...
                        cancelScheduledValues: t => (null === x && y.flush(n.context.currentTime), y.add(r(t)), _.cancelScheduledValues(t), w),
                        ...
                        setTargetAtTime: (t, e, s) => (null === x && y.flush(n.context.currentTime), y.add(h(t, e, s)), _.setTargetAtTime(t, e, s), w),
                        setValueAtTime: (t, e) => (null === x && y.flush(n.context.currentTime), y.add(l(t, e)), _.setValueAtTime(t, e), w),
        ...
        const ts = ((t, e, s, n, i, o, r, a) => class extends t {
                constructor(t, n) {
                    const a = o(t),
                        ...
                        l = r(a),
                        u = l ? e() : null;
                    super(t, !1, h, u), this._audioBufferSourceNodeRenderer = u, this._isBufferNullified = !1, this._isBufferSet = null !== c.buffer, this._nativeAudioBufferSourceNode = h, this._onended = null, this._playbackRate = s(this, l, h.playbackRate, V, F)
                }
                get buffer() {
            ...
            is = ((t, e, s, n, i, o, r, a) => class extends t {
                constructor(t, n) {
                    const c = o(t),
                        ...
                        l = i(c, h),
                        u = r(c);
                    super(t, !1, l, u ? s() : null), this._Q = e(this, u, l.Q, V, F), this._detune = e(this, u, l.detune, 1200 * Math.log2(V), -1200 * Math.log2(V)), this._frequency = e(this, u, l.frequency, t.sampleRate / 2, 0), this._gain = e(this, u, l.gain, 40 * Math.log10(V), F), this._nativeBiquadFilterNode = l, a(this, 1)
                }
                get detune() {
                    return this._detune
                }
            ...
            _s = ((t, e, s, n, i, o, r) => class extends t {
                constructor(t, r) {
                    const a = i(t),
                        ...
                        l = o(a),
                        u = l ? s() : null;
                    super(t, !1, h, u), this._constantSourceNodeRenderer = u, this._nativeConstantSourceNode = h, this._offset = e(this, l, h.offset, V, F), this._onended = null
                }
                get offset() {
                    return this._offset
                }
            ...
            vs = ((t, e, s, n, i, o) => class extends t {
                ...
                set buffer(t) {
                    if (this._nativeConvolverNode.buffer = t, null === t && null !== this._nativeConvolverNode.buffer) {
                        ...
                        this._nativeConvolverNode.buffer = t.createBuffer(1, 1, t.sampleRate), this._isBufferNullified = !0, o(this, 0)
            ...
            ks = ((t, e, s, n, i, o) => class extends t {
                constructor(t, r) {
                    const a = i(t),
                        ...
                        h = n(a, c),
                        l = o(a);
                    super(t, !1, h, l ? s() : null), this._gain = e(this, l, h.gain, V, F)
                }
                get gain() {
                    return this._gain
                }
            ...
            Is = ((t, e, s, n, i, o) => (r, a) => {
                ...
                return qt(c, a), Ft(c, a, "detune"), Ft(c, a, "frequency"), void 0 !== a.periodicWave ? c.setPeriodicWave(a.periodicWave) : Rt(c, a, "type"), e(s, (() => s(r))) || Vt(c), e(n, (() => n(r))) || o(c, r), e(i, (() => i(r))) || Nt(c), t(r, c), c
            })(Qe, ge, oe, re, ae, le),
            Fs = ((t, e, s, n, i) => () => {
                const o = new WeakMap;
                let r = null,
            ...
            Ps = ((t, e, s, n, i) => (o, {
                ...
                return null !== r && (v.curve = r instanceof Float32Array ? r : new Float32Array(r)), a !== v.oversample && (v.oversample = a), i(zt(v, d), (() => {
                    u.connect(h).connect(d), u.connect(p).connect(l).connect(f).connect(d), m = !0, n(g) && (_ = t(o, u))
                }), (() => {
            ...
            zs = (t => (e, s) => {
                ...
                return void 0 === n.orientationX ? t(e, s) : (qt(n, s), Ft(n, s, "orientationX"), Ft(n, s, "orientationY"), Ft(n, s, "orientationZ"), Ft(n, s, "positionX"), Ft(n, s, "positionY"), Ft(n, s, "positionZ"), Rt(n, s, "coneInnerAngle"), Rt(n, s, "coneOuterAngle"), Rt(n, s, "coneOuterGain"), Rt(n, s, "distanceModel"), Rt(n, s, "maxDistance"), Rt(n, s, "panningModel"), Rt(n, s, "refDistance"), Rt(n, s, "rolloffFactor"), n)
            })(Ls),
            ...
            Bs = ((t, e, s, n, i, o, r) => class extends t {
                constructor(t, a) {
                    const c = i(t),
                        ...
                        l = s(c, h),
                        u = o(c);
                    super(t, !1, l, u ? n() : null), this._nativePannerNode = l, this._orientationX = e(this, u, l.orientationX, V, F), this._orientationY = e(this, u, l.orientationY, V, F), this._orientationZ = e(this, u, l.orientationZ, V, F), this._positionX = e(this, u, l.positionX, V, F), this._positionY = e(this, u, l.positionY, V, F), this._positionZ = e(this, u, l.positionZ, V, F), r(this, 1)
                }
                get coneInnerAngle() {
                    ...
                    const _ = {
                        ...
                        set channelCount(t) {
                            l.channelCount !== t && (m && f(), ({
                                connectGraph: d,
                                disconnectGraph: f
                            } = u(e, t, l, p, h)), m && d()), l.channelCount = t
                        },
                        get channelCountMode() {
            ...
            sn = Js ? ((t, e, s, n, i, o, r, a, c, h, l, u, p) => {
                ...
                return (_, m, g = {
                    ...
                    const T = o(_),
                        S = void 0 === T.audioWorklet ? i(m).then((([t, e]) => {
                            const [n, i] = v(t, e);
                ...
                if (null === i) n(new SyntaxError);
                    ...
                    t.onerror = (e, s, i, o, r) => s === a || s === t.location.href && 1 === i && 1 === o ? (h(), n(r), !1) : null !== c ? c(e, s, i, o, r) : void 0, o.onerror = () => {
                        h(), n(new SyntaxError)
                    }, o.onload = () => {
                        h(), s()
                ...
                try {
                    ...
                    e.port.onmessage = () => o = !0, e.onprocessorerror = () => r = !0, s.connect(e), s.start(0), await n.startRendering(), await new Promise((t => setTimeout(t)))
                } catch {} finally {
                    URL.revokeObjectURL(i)
                }
                return o && !r
            })(Fe, Ce), xe) : void 0,
            nn = ((t, e) => s => t(s) || e(s))(Re, Oe),
            ...
            rn = ((t, e, s, n, i, o, r, a, c, h, l, u, p, d, f, _, m, g, v, y) => class extends f {
                constructor(e, s) {
                    super(e, s), this._nativeContext = e, this._audioWorklet = void 0 === t ? void 0 : {
            ...
            gn = (t => (e, s = void 0, n = void 0, i = 0) => void 0 === s ? e.forEach((t => t.disconnect())) : "number" == typeof s ? Tt(t, e, s).disconnect() : rt(s) ? void 0 === n ? e.forEach((t => t.disconnect(s))) : void 0 === i ? Tt(t, e, n).disconnect(s, 0) : Tt(t, e, n).disconnect(s, 0, i) : void 0 === n ? e.forEach((t => t.disconnect(s))) : Tt(t, e, n).disconnect(s, 0))(R),
            vn = new WeakMap,
            yn = ((t, e) => s => e(t, s))(vn, w),
            xn = ((t, e, s, n, i, o, r, a, c, h, l, u, p) => (d, f, m, g) => {
                ...
                const E = new lt(void 0 === m.parameterDescriptors ? [] : m.parameterDescriptors.map((({
                    name: t
                }, e) => {
                    const s = k[e];
                ...
                let R = g.channelInterpretation,
                    q = null;
                const I = 0 === g.numberOfOutputs ? [O] : M,
                    N = {
                        get bufferSize() {
                            return C
                        },
                        ...
                        connect: t.bind(null, I),
                        disconnect: h.bind(null, I),
                ...
                const U = ft(g.numberOfInputs, g.channelCount),
                    ...
                    Q = void 0 === m.parameterDescriptors ? [] : m.parameterDescriptors.reduce(((t, {
                        name: e
                    }) => ({
                        ...t,
                        [e]: new Float32Array(128)
                        ...
                        for (let n = 0; n < C; n += 128) {
                            ...
                            try {
                                const t = U.map(((t, e) => {
                                        ...
                                        const n = Y.get(e);
                                        return void 0 === n ? [] : (t.every((t => t.every((t => 0 === t)))) && (1 === n ? Y.delete(e) : Y.set(e, n - 1)), t)
                                    })),
                ...
                const H = r(d, {
                    ...
                    J = () => O.connect(H).connect(d.destination),
                    K = () => {
            ...
            })(Xe, _n, Ye, as, Lt, ds, Bt, mn, gn, Ks, tt, Fe, Ce, $e, Te, Cs),
            Tn = (t => e => t.get(e))(tn),
            Sn = (t => (e, s) => {
                t.set(e, s)
            })(vn),
            ...
            })(fn, Ve, Je, bn, wn, j, Tn, ke, Oe, Fe, 0, Sn, 0, ue) : void 0,
            An = ((t, e) => (s, n, i) => {
                if (null === e) throw new Error("Missing the native OfflineAudioContext constructor.");
                try {
                    return new e(s, n, i)
            ...
            En = ((t, e) => s => t.has(s) || e(s))(l, Ie),
            Rn = ((t, e) => s => {
                const n = t.get(s);
                return e(n) || e(s)
            })(u, Oe),
            qn = () => (async (t, e, s, n, i, o, r, a, c, h, l, u, p, d, f, _) => !!(t(e, e) && t(s, s) && t(i, i) && t(o, o) && t(a, a) && t(c, c) && t(h, h) && t(l, l) && t(u, u) && t(p, p) && t(d, d)) && (await Promise.all([t(n, n), t(r, r), t(f, f), t(_, _)])).every((t => t)))(ge, (t => () => {
                if (null === t) return !1;
                ...
                try {
                    ...
                    })), e.port.onmessage = () => r = !0, s.connect(e), s.start(0), await i.startRendering(), r = await new Promise((t => {
                        n.port1.onmessage = ({
                            data: e
                        }) => t(1 === e), n.port1.postMessage(0)
                    }))
                } catch {} finally {
        ...
        function Yn(t) {
            In(t) && Qn && !Zn && (Zn = !0, Kn("Events scheduled inside of scheduled callbacks should use the passed in scheduling time. See https://github.com/Tonejs/Tone.js/wiki/Accurate-Timing"))
        }
        let $n = console;
        ...
        class ii {
            constructor(t, e, s, n) {
                this._callback = t, this._type = e, this._minimumUpdateInterval = Math.max(128 / (n || 44100), .001), this.updateInterval = s, this._createClock()
            }
            _createWorker() {
        ...
        function ui(t, e, s = [], n) {
            ...
            if (Pn(o[0]) && n && !Reflect.has(o[0], n) && (Object.keys(o[0]).some((e => Reflect.has(t, e))) || (li(i, {
                ...
                for (let t = 0; t < s.length; t++) Fn(o[t]) && (i[s[t]] = o[t]);
            return li(t, i)
        }
        ...
        class Ai extends fi {
            ...
            on(t, e) {
                return t.split(/\W+/).forEach((t => {
                    In(this._events) && (this._events = {}), this._events.hasOwnProperty(t) || (this._events[t] = []), this._events[t].push(e)
                })), this
            }
            once(t, e) {
                const s = (...n) => {
            ...
            off(t, e) {
                return t.split(/\W+/).forEach((t => {
                    if (In(this._events) && (this._events = {}), this._events.hasOwnProperty(t))
                        if (In(e)) this._events[t] = [];
                        else {
        ...
        class Oi extends Ci {
            constructor() {
                ...
                }), this._latencyHint = s.latencyHint), this._ticker = new ii(this.emit.bind(this, "tick"), s.clockSource, s.updateInterval, this._context.sampleRate), this.on("tick", this._timeoutLoop.bind(this)), this._context.onstatechange = () => {
            ...
            initialize() {
                var t;
                return this._initialized || (t = this, bi.forEach((e => e(t))), this._initialized = !0), this
            }
            createAnalyser() {
            ...
            createAudioWorkletNode(t, e) {
                return function(t, e, s) {
                    return Bn(Fn(kn), "AudioWorkletNode only works in a secure context (https or localhost)"), new(t instanceof(null == ti ? void 0 : ti.BaseAudioContext) ? null == ti ? void 0 : ti.AudioWorkletNode : kn)(t, e, s)
                }(this.rawContext, t, e)
            }
            addAudioWorkletModule(t) {
                return ni(this, void 0, void 0, (function*() {
                    Bn(Fn(this.rawContext.audioWorklet), "AudioWorkletNode is only available in a secure context (https or localhost)"), this._workletPromise || (this._workletPromise = this.rawContext.audioWorklet.addModule(t)), yield this._workletPromise
                }))
            }
            workletsAreReady() {
                return ni(this, void 0, void 0, (function*() {
            ...
            close() {
                return ni(this, void 0, void 0, (function*() {
                    var t;
                    ci(this._context) && "closed" !== this.state && !this._closeStarted && (this._closeStarted = !0, yield this._context.close()), this._initialized && (t = this, Si.forEach((e => e(t))))
                }))
            }
            getConstant(t) {
            ...
            _timeoutLoop() {
                const t = this.now();
                this._timeouts.forEachBefore(t, (t => {
        ...
        function Di(t, e) {
            Ln(e) ? e.forEach((e => Di(t, e))) : Object.defineProperty(t, e, {
                enumerable: !0,
                writable: !1
            })
        }
        ...
        class Ri extends fi {
            ...
            static load(t) {
                return ni(this, void 0, void 0, (function*() {
                    const e = "" === Ri.baseUrl || Ri.baseUrl.endsWith("/") ? Ri.baseUrl : Ri.baseUrl + "/",
                        s = yield fetch(e + t);
                    if (!s.ok) throw new Error(`could not load url: ${t}`);
                    const n = yield s.arrayBuffer();
                    return yield Vi().decodeAudioData(n)
                }))
            }
        ...
        class qi extends Oi {
            constructor() {
                ...
                super({
                    clockSource: "offline",
                    context: ai(arguments[0]) ? arguments[0] : (t = arguments[0], e = arguments[1] * arguments[2], s = arguments[2], new On(t, e, s)),
                    lookAhead: 0,
            ...
            render() {
                return ni(this, arguments, void 0, (function*(t = !0) {
        ...
        function Vi() {
            return Fi === Ii && ei && Ni(new Oi), Fi
        }

        function Ni(t, e = !1) {
            e && Fi.dispose(), Fi = ci(t) ? new Oi(t) : ai(t) ? new qi(t) : t
        }
        ...
        class Qi extends fi {
            ...
            valueOf() {
                if (this._val instanceof Qi && this.fromType(this._val), In(this._val)) return this._noArg();
                if (zn(this._val) && In(this._units)) {
            ...
            get() {
                ...
                return Object.keys(t).forEach((e => {
                    if (Reflect.has(this, e)) {
                        const s = this[e];
                        Fn(s) && Fn(s.value) && Fn(s.setValueAtTime) ? t[e] = s.value : s instanceof eo ? t[e] = s._getPartialProperties(t[e]) : Ln(s) || Nn(s) || zn(s) || jn(s) ? t[e] = s : delete t[e]
                    }
                })), t
            }
            set(t) {
                return Object.keys(t).forEach((e => {
                    Reflect.has(this, e) && Fn(this[e]) && (this[e] && Fn(this[e].value) && Fn(this[e].setValueAtTime) ? this[e].value !== t[e] && (this[e].value = t[e]) : this[e] instanceof eo ? this[e].set(t[e]) : this[e] = t[e])
                })), this
            }
        }
        class so extends wi {
            ...
            setStateAtTime(t, e, s) {
                return Un(e, 0), this.add(Object.assign({}, s, {
                    state: t,
                    time: e
                })), this
            }
        ...
        class no extends eo {
            constructor() {
                ...
                for (super(t), this.name = "Param", this.overridden = !1, this._minOutput = 1e-7, Bn(Fn(t.param) && (oi(t.param) || t.param instanceof no), "param must be an AudioParam"); !oi(t.param);) t.param = t.param._param;
                this._swappable = !!Fn(t.swappable) && t.swappable, this._swappable ? (this.input = this.context.createGain(), this._param = t.param, this.input.connect(this._param)) : this._param = this.input = t.param, this._events = new wi(1e3), this._initialValue = this._param.defaultValue, this.units = t.units, this.convert = t.convert, this._minValue = t.minValue, this._maxValue = t.maxValue, Fn(t.value) && t.value !== this._toType(this._initialValue) && this.setValueAtTime(t.value, 0)
            }
            static getDefaults() {
            ...
            get minValue() {
                return Fn(this._minValue) ? this._minValue : "time" === this.units || "frequency" === this.units || "normalRange" === this.units || "positive" === this.units || "transportTime" === this.units || "ticks" === this.units || "bpm" === this.units || "hertz" === this.units || "samples" === this.units ? 0 : "audioRange" === this.units ? -1 : "decibels" === this.units ? -1 / 0 : this._param.minValue
            }
            get maxValue() {
                return Fn(this._maxValue) ? this._maxValue : "normalRange" === this.units || "audioRange" === this.units ? 1 : this._param.maxValue
            }
            _is(t, e) {
                return this.units === e
            }
            _assertRange(t) {
                return Fn(this.maxValue) && Fn(this.minValue) && Un(t, this._fromType(this.minValue), this._fromType(this.maxValue)), t
            }
            _fromType(t) {
            ...
            exponentialApproachValueAtTime(t, e, s) {
                ...
                return this.setTargetAtTime(t, e, n), this.cancelAndHoldAtTime(e + .9 * s), this.linearRampToValueAtTime(t, e + s), this
            }
        ...
        class io extends eo {
            ...
            get numberOfInputs() {
                return Fn(this.input) ? oi(this.input) || this.input instanceof no ? 1 : this.input.numberOfInputs : 0
            }
            get numberOfOutputs() {
                return Fn(this.output) ? this.output.numberOfOutputs : 0
            }
            _isAudioNode(t) {
                return Fn(t) && (t instanceof io || ri(t))
            }
            _getInternalNodes() {
            ...
            dispose() {
                return super.dispose(), Fn(this.input) && (this.input instanceof io ? this.input.dispose() : ri(this.input) && this.input.disconnect()), Fn(this.output) && (this.output instanceof io ? this.output.dispose() : ri(this.output) && this.output.disconnect()), this._internalChannels = [], this
            }
        }
        ...
        function ro(t, e, s = 0, n = 0) {
            for (Bn(Fn(t), "Cannot connect from undefined node"), Bn(Fn(e), "Cannot connect to undefined node"), (e instanceof io || ri(e)) && Bn(e.numberOfInputs > 0, "Cannot connect to node with no inputs"), Bn(t.numberOfOutputs > 0, "Cannot connect from node with no outputs"); e instanceof io || e instanceof no;) Fn(e.input) && (e = e.input);
            for (; t instanceof io;) Fn(t.output) && (t = t.output);
        ...
        function ao(t, e, s = 0, n = 0) {
            ...
            for (; !ri(t);) Fn(t.output) && (t = t.output);
            oi(e) ? t.disconnect(e, s) : ri(e) ? t.disconnect(e, s, n) : t.disconnect()
        }

        function co(...t) {
            const e = t.pop();
            Fn(e) && t.forEach((t => ro(t, e)))
        }
        class ho extends io {
            constructor() {
                const t = ui(ho.getDefaults(), arguments, ["gain", "units"]);
                super(t), this.name = "Gain", this._gainNode = this.context.createGain(), this.input = this._gainNode, this.output = this._gainNode, this.gain = new no({
        ...
        class lo extends io {
            constructor(t) {
                super(t), this.onended = Ei, this._startTime = -1, this._stopTime = -1, this._timeout = -1, this.output = new ho({
                    context: this.context,
                    gain: 0
            ...
            _onended() {
                if (this.onended !== Ei && (this.onended(this), this.onended = Ei, !this.context.isOffline)) {
                    ...
                    "undefined" != typeof requestIdleCallback ? requestIdleCallback(t) : setTimeout(t, 10)
                }
            }
            get state() {
        ...
        class uo extends lo {
            constructor() {
                ...
                super(t), this.name = "ToneConstantSource", this._source = this.context.createConstantSource(), ro(this._source, this._gainNode), this.offset = new no({
                    context: this.context,
                    convert: t.convert,
        ...
        class po extends io {
            constructor() {
                ...
                super(t), this.name = "Signal", this.override = !0, this.output = this._constantSource = new uo({
                    context: this.context,
                    convert: t.convert,
                    offset: t.value,
                    units: t.units,
        ...
        class _o extends no {
            constructor() {
                ...
                super(t), this.name = "TickParam", this._events = new wi(1 / 0), this._multiplier = 1, this._multiplier = t.multiplier, this._events.cancel(0), this._events.add({
                    ticks: 0,
                    time: 0,
                    type: "setValueAtTime",
        ...
        class mo extends po {
            constructor() {
                ...
                super(t), this.name = "TickSignal", this.input = this._param = new _o({
                    context: this.context,
                    convert: t.convert,
        ...
        class go extends eo {
            constructor() {
                ...
                super(t), this.name = "TickSource", this._state = new so, this._tickOffset = new wi, this._ticksAtTime = new wi, this._secondsAtTime = new wi, this.frequency = new mo({
                    context: this.context,
                    units: t.units,
                    value: t.frequency
                }), Di(this, "frequency"), this._state.setStateAtTime("stopped", 0), this.setTicksAtTime(0, 0)
            }
            static getDefaults() {
            ...
            start(t, e) {
                ...
                return "started" !== this._state.getValueAtTime(s) && (this._state.setStateAtTime("started", s), Fn(e) && this.setTicksAtTime(e, s), this._ticksAtTime.cancel(s), this._secondsAtTime.cancel(s)), this
            }
            stop(t) {
                const e = this.toSeconds(t);
        ...
        class vo extends eo {
            constructor() {
                ...
                super(t), this.name = "Clock", this.callback = Ei, this._lastUpdate = 0, this._state = new so("stopped"), this._boundLoop = this._loop.bind(this), this.callback = t.callback, this._tickSource = new go({
                    context: this.context,
                    frequency: t.frequency,
                    units: t.units
                }), this._lastUpdate = 0, this.frequency = this._tickSource.frequency, Di(this, "frequency"), this._state.setStateAtTime("stopped", 0), this.context.on("tick", this._boundLoop)
            }
            static getDefaults() {
                return Object.assign(eo.getDefaults(), {
                    callback: Ei,
        ...
        class yo extends io {
            constructor() {
                ...
                this._maxDelay = Math.max(e, this.toSeconds(t.delayTime)), this._delayNode = this.input = this.output = this.context.createDelay(e), this.delayTime = new no({
                    context: this.context,
        ...
        class xo extends io {
            constructor() {
                ...
                super(t), this.name = "Volume", this.input = this.output = new ho({
                    context: this.context,
                    gain: t.volume,
                    units: "decibels"
                }), this.volume = this.output.gain, Di(this, "volume"), this._unmutedVolume = t.volume, this.mute = t.mute
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    mute: !1,
        ...
        class wo extends io {
            constructor() {
                ...
                super(t), this.name = "Destination", this.input = new xo({
                    context: this.context
                }), this.output = new ho({
                    context: this.context
                }), this.volume = this.input.volume, oo(this.input, this.output, this.context.rawContext.destination), this.mute = t.mute, this._internalChannels = [this.input, this.context.rawContext.destination, this.output]
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    mute: !1,
        ...
        function To(t, e) {
            return ni(this, arguments, void 0, (function*(t, e, s = 2, n = Vi().sampleRate) {
                const i = Vi(),
                    o = new qi(s, e, n);
                Ni(o), yield t(o);
                const r = o.render();
        ...
        class So extends fi {
            ...
            add(t, e, s = Ei, n = Ei) {
                return zn(e) ? (this.baseUrl && "data:audio/" === e.trim().substring(0, 11).toLowerCase() && (this.baseUrl = ""), this._buffers.set(t.toString(), new Ri(this.baseUrl + e, s, n))) : this._buffers.set(t.toString(), new Ri(e, s, n)), this
            }
            dispose() {
        ...
        class Mo extends fi {
            ...
            add(t) {
                Bn(Fn(t.time), "Events must have a time property"), Bn(Fn(t.duration), "Events must have a duration parameter"), t.time = t.time.valueOf();
        ...
        class Io extends qo {
            constructor() {
                ...
                super(t), this.name = "WaveShaper", this._shaper = this.context.createWaveShaper(), this.input = this._shaper, this.output = this._shaper, Ln(t.mapping) || t.mapping instanceof Float32Array ? this.curve = Float32Array.from(t.mapping) : Vn(t.mapping) && this.setMap(t.mapping, t.length)
            }
            static getDefaults() {
                return Object.assign(po.getDefaults(), {
                    length: 1024
        ...
        class Fo extends qo {
            constructor() {
                ...
                super(t), this.name = "Pow", this._exponentScaler = this.input = this.output = new Io({
                    context: this.context,
        ...
        class No extends Vo {
            ...
            _createEvent() {
                return vi(this._nextTick, this.floatTime + this.duration) ? this.transport.scheduleOnce(this.invoke.bind(this), new Co(this.context, this._nextTick).toSeconds()) : -1
            }
            _createEvents(t) {
                vi(this._nextTick + this._interval, this.floatTime + this.duration) && (this._nextTick += this._interval, this._currentId = this._nextId, this._nextId = this.transport.scheduleOnce(this.invoke.bind(this), new Co(this.context, this._nextTick).toSeconds()))
            }
            _restart(t) {
        ...
        class Po extends eo {
            constructor() {
                ...
                super(t), this.name = "Transport", this._loop = new Ro(!1), this._loopStart = 0, this._loopEnd = 0, this._scheduledEvents = {}, this._timeline = new wi, this._repeatedEvents = new Mo, this._syncedSignals = [], this._swingAmount = 0, this._ppq = t.ppq, this._clock = new vo({
                    callback: this._processTick.bind(this),
                    context: this.context,
                    frequency: 0,
                    units: "bpm"
                }), this._bindClockEvents(), this.bpm = this._clock.frequency, this._clock.frequency.multiplier = t.ppq, this.bpm.setValueAtTime(t.bpm, 0), Di(this, "bpm"), this._timeSignature = t.timeSignature, this._swingTicks = t.ppq / 2
            }
            static getDefaults() {
                return Object.assign(eo.getDefaults(), {
                    bpm: 120,
            ...
            start(t, e) {
                let s;
                return this.context.resume(), Fn(e) && (s = this.toTicks(e)), this._clock.start(t, s), this
            }
            stop(t) {
            ...
            syncSignal(t, e) {
                ...
                const r = new ho(e);
                return n.connect(r), r.connect(t._param), o.push(r), this._syncedSignals.push({
                    initial: t.value,
                    nodes: o,
                    signal: t
                }), t.value = 0, this
        ...
        class jo extends io {
            constructor(t) {
                super(t), this.input = void 0, this._state = new so("stopped"), this._synced = !1, this._scheduled = [], this._syncedStart = Ei, this._syncedStop = Ei, this._state.memory = 100, this._state.increasing = !0, this._volume = this.output = new xo({
                    context: this.context,
                    mute: t.mute,
                    volume: t.volume
                }), this.volume = this._volume.volume, Di(this, "volume"), this.onstop = t.onstop
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    mute: !1,
            ...
            start(t, e, s) {
                let n = In(t) && this._synced ? this.context.transport.seconds : this.toSeconds(t);
            ...
            stop(t) {
                let e = In(t) && this._synced ? this.context.transport.seconds : this.toSeconds(t);
                if (e = this._clampToCurrentTime(e), "started" === this._state.getValueAtTime(e) || Fn(this._state.getNextState("started", e))) {
        ...
        class Lo extends lo {
            constructor() {
                ...
                super(t), this.name = "ToneBufferSource", this._source = this.context.createBufferSource(), this._internalChannels = [this._source], this._sourceStarted = !1, this._sourceStopped = !1, ro(this._source, this._gainNode), this._source.onended = () => this._stopSource(), this.playbackRate = new no({
                    context: this.context,
                    param: this._source.playbackRate,
                    units: "positive",
                    value: t.playbackRate
                }), this.loop = t.loop, this.loopStart = t.loopStart, this.loopEnd = t.loopEnd, this._buffer = new Ri(t.url, t.onload, t.onerror), this._internalChannels.push(this._source)
            }
            static getDefaults() {
                return Object.assign(lo.getDefaults(), {
                    url: new Ri,
            ...
            start(t, e, s, n = 1) {
                ...
                if (this._source.buffer = this.buffer.get(), this._source.loopEnd = this.toSeconds(this.loopEnd) || this.buffer.duration, vi(o, this.buffer.duration) && (this._sourceStarted = !0, this._source.start(i, o)), Fn(s)) {
        ...
        class zo extends jo {
            ...
            static getDefaults() {
                return Object.assign(jo.getDefaults(), {
                    fadeIn: 0,
                    fadeOut: 0,
                    playbackRate: 1,
                    type: "white"
        ...
        class Go extends io {
            constructor() {
                ...
                super(t), this.name = "UserMedia", this._volume = this.output = new xo({
                    context: this.context,
                    volume: t.volume
                }), this.volume = this._volume.volume, Di(this, "volume"), this.mute = t.mute
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    mute: !1,
            ...
            open(t) {
                return ni(this, void 0, void 0, (function*() {
                    ...
                    Nn(t) ? this._device = e[t] : (this._device = e.find((e => e.label === t || e.deviceId === t)), !this._device && e.length > 0 && (this._device = e[0]), Bn(Fn(this._device), `No matching device ${t}`));
                    const s = {
                        audio: {
                            echoCancellation: !1,
            ...
            static get supported() {
                return Fn(navigator.mediaDevices) && Fn(navigator.mediaDevices.getUserMedia)
            }
        }
        ...
        class Zo extends lo {
            constructor() {
                ...
                super(t), this.name = "ToneOscillatorNode", this._oscillator = this.context.createOscillator(), this._internalChannels = [this._oscillator], ro(this._oscillator, this._gainNode), this.type = t.type, this.frequency = new no({
                    context: this.context,
        ...
        class Xo extends jo {
            constructor() {
                ...
                super(t), this.name = "Oscillator", this._oscillator = null, this.frequency = new po({
                    context: this.context,
                    units: "frequency",
                    value: t.frequency
                }), Di(this, "frequency"), this.detune = new po({
                    context: this.context,
                    units: "cents",
                    value: t.detune
                }), Di(this, "detune"), this._partials = t.partials, this._partialCount = t.partialCount, this._type = t.type, t.partialCount && "custom" !== t.type && (this._type = this.baseType + t.partialCount.toString()), this.phase = t.phase
            }
            static getDefaults() {
                return Object.assign(jo.getDefaults(), {
                    detune: 0,
            ...
            set type(t) {
                ...
                if (0 === this._phase && e) this._wave = void 0, this._partialCount = 0, null !== this._oscillator && (this._oscillator.type = t);
                    ...
                    if (Fn(e)) {
                        ...
                        this._wave = n, null !== this._oscillator && this._oscillator.setPeriodicWave(this._wave), Xo._periodicWaveCache.push({
                            imag: s,
                            ...
                            type: this._type,
                            wave: this._wave
                        }), Xo._periodicWaveCache.length > 100 && Xo._periodicWaveCache.shift()
                    }
                }
            }
            get baseType() {
            ...
            asArray() {
                return ni(this, arguments, void 0, (function*(t = 1024) {
                    return Qo(this, t)
                }))
            }
            dispose() {
        ...
        class Yo extends qo {
            constructor() {
                super(...arguments), this.name = "AudioToGain", this._norm = new Io({
                    context: this.context,
                    mapping: t => (t + 1) / 2
        ...
        class $o extends po {
            constructor() {
                ...
                super(t), this.name = "Multiply", this.override = !1, this._mult = this.input = this.output = new ho({
                    context: this.context,
                    minValue: t.minValue,
                    maxValue: t.maxValue
        ...
        class Ho extends jo {
            constructor() {
                ...
                super(t), this.name = "AMOscillator", this._modulationScale = new Yo({
                    context: this.context
                }), this._modulationNode = new ho({
                    context: this.context
                }), this._carrier = new Xo({
                    context: this.context,
                    detune: t.detune,
                    frequency: t.frequency,
                    ...
                    phase: t.phase,
                    type: t.type
                }), this.frequency = this._carrier.frequency, this.detune = this._carrier.detune, this._modulator = new Xo({
                    context: this.context,
                    phase: t.phase,
                    type: t.modulationType
                }), this.harmonicity = new $o({
                    context: this.context,
                    units: "positive",
                    value: t.harmonicity
                }), this.frequency.chain(this.harmonicity, this._modulator.frequency), this._modulator.chain(this._modulationScale, this._modulationNode.gain), this._carrier.chain(this._modulationNode, this.output), Di(this, ["frequency", "detune", "harmonicity"])
            }
            static getDefaults() {
        ...
        class Jo extends jo {
            constructor() {
                ...
                super(t), this.name = "FMOscillator", this._modulationNode = new ho({
                    context: this.context,
                    gain: 0
                }), this._carrier = new Xo({
                    context: this.context,
        ...
        class Ko extends jo {
            constructor() {
                ...
                super(t), this.name = "PulseOscillator", this._widthGate = new ho({
                    context: this.context,
                    gain: 0
                }), this._thresh = new Io({
                    context: this.context,
                    ...
                    phase: t.phase,
                    type: "triangle"
                }), this.frequency = this._triangle.frequency, this.detune = this._triangle.detune, this._triangle.chain(this._thresh, this.output), this.width.chain(this._widthGate, this._thresh), Di(this, ["width", "frequency", "detune"])
            }
            static getDefaults() {
                return Object.assign(jo.getDefaults(), {
                    detune: 0,
        ...
        class tr extends jo {
            constructor() {
                ...
                super(t), this.name = "FatOscillator", this._oscillators = [], this.frequency = new po({
                    context: this.context,
                    units: "frequency",
                    value: t.frequency
                }), this.detune = new po({
                    ...
                    units: "cents",
                    value: t.detune
                }), this._spread = t.spread, this._type = t.type, this._phase = t.phase, this._partials = t.partials, this._partialCount = t.partialCount, this.count = t.count, Di(this, ["frequency", "detune"])
            }
            static getDefaults() {
                return Object.assign(Xo.getDefaults(), {
                    count: 3,
        ...
        class er extends jo {
            constructor() {
                ...
                super(t), this.name = "PWMOscillator", this.sourceType = "pwm", this._scale = new $o({
                    context: this.context,
                    value: 2
                }), this._pulse = new Ko({
                    context: this.context,
                    frequency: t.modulationFrequency
                }), this._pulse.carrierType = "sine", this.modulationFrequency = this._pulse.frequency, this._modulator = new Xo({
                    context: this.context,
                    detune: t.detune,
                    frequency: t.frequency,
                    onstop: () => this.onstop(this),
                    phase: t.phase
                }), this.frequency = this._modulator.frequency, this.detune = this._modulator.detune, this._modulator.chain(this._scale, this._pulse.width), this._pulse.connect(this.output), Di(this, ["modulationFrequency", "frequency", "detune"])
            }
            static getDefaults() {
                return Object.assign(jo.getDefaults(), {
                    detune: 0,
        ...
        class nr extends jo {
            constructor() {
                ...
                super(t), this.name = "OmniOscillator", this.frequency = new po({
                    context: this.context,
                    units: "frequency",
                    value: t.frequency
                }), this.detune = new po({
                    ...
                    units: "cents",
                    value: t.detune
                }), Di(this, ["frequency", "detune"]), this.set(t)
            }
            static getDefaults() {
        ...
        class ir extends po {
            constructor() {
                super(ui(ir.getDefaults(), arguments, ["value"])), this.override = !1, this.name = "Add", this._sum = new ho({
                    context: this.context
        ...
        class or extends qo {
            constructor() {
                ...
                super(t), this.name = "Scale", this._mult = this.input = new $o({
                    context: this.context,
                    value: t.max - t.min
                }), this._add = this.output = new ir({
                    context: this.context,
                    value: t.min
        ...
        class rr extends qo {
            constructor() {
                super(ui(rr.getDefaults(), arguments)), this.name = "Zero", this._gain = new ho({
                    context: this.context
        ...
        class ar extends io {
            constructor() {
                ...
                super(t), this.name = "LFO", this._stoppedValue = 0, this._units = "number", this.convert = !0, this._fromType = no.prototype._fromType, this._toType = no.prototype._toType, this._is = no.prototype._is, this._clampValue = no.prototype._clampValue, this._oscillator = new Xo(t), this.frequency = this._oscillator.frequency, this._amplitudeGain = new ho({
                    context: this.context,
                    gain: t.amplitude,
                    units: "normalRange"
                    ...
                    context: this.context
                }), this._scaler = this.output = new or({
                    context: this.context,
                    max: t.max,
                    min: t.min
                }), this.units = t.units, this.min = t.min, this.max = t.max, this._oscillator.chain(this._amplitudeGain, this._a2g, this._scaler), this._zeros.connect(this._a2g), this._stoppedSignal.connect(this._a2g), Di(this, ["amplitude", "frequency"]), this.phase = t.phase
            }
            static getDefaults() {
                return Object.assign(Xo.getDefaults(), {
                    amplitude: 1,
        ...
        class lr extends jo {
            constructor() {
                ...
                super(t), this.name = "Player", this._activeSources = new Set, this._buffer = new Ri({
            ...
            _start(t, e, s) {
                ...
                this._loop || this._synced || (this._state.cancel(t + o), this._state.setStateAtTime("stopped", t + o, {
                    implicitEnd: !0
                })), this._activeSources.add(r), this._loop && In(i) ? r.start(t, n) : r.start(t, n, o - this.toSeconds(this.fadeOut))
            }
            _stop(t) {
                const e = this.toSeconds(t);
        ...
        si([hr(0)], lr.prototype, "fadeIn", void 0), si([hr(0)], lr.prototype, "fadeOut", void 0);
        class ur extends io {
            constructor() {
                const t = ui(ur.getDefaults(), arguments, ["urls", "onload"], "urls");
                super(t), this.name = "Players", this.input = void 0, this._players = new Map, this._volume = this.output = new xo({
                    context: this.context,
                    volume: t.volume
                }), this.volume = this._volume.volume, Di(this, "volume"), this._buffers = new So({
                    urls: t.urls,
                    onload: t.onload,
                    baseUrl: t.baseUrl,
                    onerror: t.onerror
        ...
        class pr extends jo {
            constructor() {
                ...
                super(t), this.name = "GrainPlayer", this._loopStart = 0, this._loopEnd = 0, this._activeSources = [], this.buffer = new Ri({
                    onload: t.onload,
                    onerror: t.onerror,
                    reverse: t.reverse,
                    url: t.url
            ...
            _tick(t) {
                ...
                i.start(t, this._grainSize * e), i.stop(t + this._grainSize / this.playbackRate), this._activeSources.push(i), i.onended = () => {
                    const t = this._activeSources.indexOf(i); - 1 !== t && this._activeSources.splice(t, 1)
                }
            }
            get playbackRate() {
                return this._playbackRate
            ...
            set playbackRate(t) {
                Un(t, .001), this._playbackRate = t, this.grainSize = this._grainSize
            }
            get loopStart() {
                return this._loopStart
            }
        ...
        class dr extends qo {
            constructor() {
                super(...arguments), this.name = "Abs", this._abs = new Io({
                    context: this.context,
        ...
        class fr extends qo {
            constructor() {
                super(...arguments), this.name = "GainToAudio", this._norm = new Io({
                    context: this.context,
        ...
        class _r extends qo {
            constructor() {
                super(...arguments), this.name = "Negate", this._multiply = new $o({
                    context: this.context,
                    value: -1
        ...
        class mr extends po {
            constructor() {
                super(ui(mr.getDefaults(), arguments, ["value"])), this.override = !1, this.name = "Subtract", this._sum = new ho({
                    context: this.context
                }), this.input = this._sum, this.output = this._sum, this._neg = new _r({
                    context: this.context
        ...
        class gr extends qo {
            constructor() {
                super(ui(gr.getDefaults(), arguments)), this.name = "GreaterThanZero", this._thresh = this.output = new Io({
                    context: this.context,
                    length: 127,
                    mapping: t => t <= 0 ? 0 : 1
                }), this._scale = this.input = new $o({
                    context: this.context,
                    value: 1e4
        ...
        class vr extends po {
            constructor() {
                ...
                super(t), this.name = "GreaterThan", this.override = !1, this._subtract = this.input = new mr({
                    context: this.context,
                    value: t.value
                }), this._gtz = this.output = new gr({
                    context: this.context
                }), this.comparator = this._param = this._subtract.subtrahend, Di(this, "comparator"), this._subtract.connect(this._gtz)
            }
            static getDefaults() {
                return Object.assign(po.getDefaults(), {
                    value: 0
        ...
        class yr extends or {
            constructor() {
                ...
                super(t), this.name = "ScaleExp", this.input = this._exp = new Fo({
                    context: this.context,
                    value: t.exponent
        ...
        class wr extends io {
            constructor() {
                ...
                super(t), this.name = "Envelope", this._sig = new po({
                    context: this.context,
                    value: 0
        ...
        si([hr(0)], wr.prototype, "attack", void 0), si([hr(0)], wr.prototype, "decay", void 0), si([cr(0, 1)], wr.prototype, "sustain", void 0), si([hr(0)], wr.prototype, "release", void 0);
        const br = (() => {
            const t = 128;
            let e, s;
            const n = [];
        ...
        class Tr extends io {
            constructor() {
                ...
                super(t), this._scheduledEvents = [], this._synced = !1, this._original_triggerAttack = this.triggerAttack, this._original_triggerRelease = this.triggerRelease, this._syncedRelease = t => this._original_triggerRelease(t), this._volume = this.output = new xo({
                    context: this.context,
                    volume: t.volume
                }), this.volume = this._volume.volume, Di(this, "volume")
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    volume: 0
        ...
        si([hr(0)], Sr.prototype, "portamento", void 0);
        class kr extends wr {
            constructor() {
                super(ui(kr.getDefaults(), arguments, ["attack", "decay", "sustain", "release"])), this.name = "AmplitudeEnvelope", this._gainNode = new ho({
                    context: this.context,
                    gain: 0
        ...
        class Ar extends Sr {
            constructor() {
                ...
                super(t), this.name = "Synth", this.oscillator = new nr(Object.assign({
                    ...
                    context: this.context
                }, t.envelope)), this.oscillator.chain(this.envelope, this.output), Di(this, ["oscillator", "frequency", "detune", "envelope"])
            }
            static getDefaults() {
                return Object.assign(Sr.getDefaults(), {
                    envelope: Object.assign(di(wr.getDefaults(), Object.keys(io.getDefaults())), {
                        attack: .005,
                        decay: .1,
                        release: 1,
                        sustain: .3
                    }),
                    oscillator: Object.assign(di(nr.getDefaults(), [...Object.keys(jo.getDefaults()), "frequency", "detune"]), {
                        type: "triangle"
                    })
                })
            }
        ...
        class Cr extends Sr {
            constructor() {
                ...
                super(t), this.name = "ModulationSynth", this._carrier = new Ar({
                    context: this.context,
                    ...
                    context: this.context,
                    gain: 0
                }), Di(this, ["frequency", "harmonicity", "oscillator", "envelope", "modulation", "modulationEnvelope", "detune"])
            }
            static getDefaults() {
                return Object.assign(Sr.getDefaults(), {
                    harmonicity: 3,
                    ...
                    modulation: Object.assign(di(nr.getDefaults(), [...Object.keys(jo.getDefaults()), "frequency", "detune"]), {
                        type: "square"
                    }),
                    modulationEnvelope: Object.assign(di(wr.getDefaults(), Object.keys(io.getDefaults())), {
                        attack: .5,
                        decay: 0,
                        sustain: 1,
                        release: .5
        ...
        class Or extends Cr {
            constructor() {
                super(ui(Or.getDefaults(), arguments)), this.name = "AMSynth", this._modulationScale = new Yo({
                    context: this.context
        ...
        class Dr extends io {
            constructor() {
                ...
                super(t), this.name = "BiquadFilter", this._filter = this.context.createBiquadFilter(), this.input = this.output = this._filter, this.Q = new no({
                    context: this.context,
                    units: "number",
                    value: t.Q,
        ...
        class Mr extends io {
            constructor() {
                ...
                super(t), this.name = "Filter", this.input = new ho({
                    context: this.context
                }), this.output = new ho({
                    context: this.context
                }), this._filters = [], this._filters = [], this.Q = new po({
                    context: this.context,
                    units: "positive",
                    value: t.Q
                    ...
                    convert: !1,
                    value: t.gain
                }), this._type = t.type, this.rolloff = t.rolloff, Di(this, ["detune", "frequency", "gain", "Q"])
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    Q: 1,
        ...
        class Er extends wr {
            constructor() {
                ...
                super(t), this.name = "FrequencyEnvelope", this._octaves = t.octaves, this._baseFrequency = this.toFrequency(t.baseFrequency), this._exponent = this.input = new Fo({
                    context: this.context,
                    value: t.exponent
                }), this._scale = this.output = new or({
                    context: this.context,
        ...
        class Rr extends Sr {
            constructor() {
                ...
                super(t), this.name = "MonoSynth", this.oscillator = new nr(Object.assign(t.oscillator, {
                    context: this.context,
                    detune: t.detune,
                    onstop: () => this.onsilence(this)
                    ...
                    context: this.context
                })), this.oscillator.chain(this.filter, this.envelope, this.output), this.filterEnvelope.connect(this.filter.frequency), Di(this, ["oscillator", "frequency", "detune", "filter", "filterEnvelope", "envelope"])
            }
            static getDefaults() {
                return Object.assign(Sr.getDefaults(), {
                    envelope: Object.assign(di(wr.getDefaults(), Object.keys(io.getDefaults())), {
                    ...
                    filter: Object.assign(di(Mr.getDefaults(), Object.keys(io.getDefaults())), {
                        Q: 1,
                        rolloff: -12,
                        type: "lowpass"
                    }),
                    filterEnvelope: Object.assign(di(Er.getDefaults(), Object.keys(io.getDefaults())), {
                        attack: .6,
                        baseFrequency: 200,
                        decay: .2,
                        exponent: 2,
                    ...
                    oscillator: Object.assign(di(nr.getDefaults(), Object.keys(jo.getDefaults())), {
                        type: "sawtooth"
                    })
                })
            }
        ...
        class qr extends Sr {
            constructor() {
                ...
                super(t), this.name = "DuoSynth", this.voice0 = new Rr(Object.assign(t.voice0, {
                    context: this.context,
                    onsilence: () => this.onsilence(this)
            ...
            static getDefaults() {
                return li(Sr.getDefaults(), {
                    vibratoAmount: .5,
                    vibratoRate: 5,
                    harmonicity: 1.5,
                    voice0: li(di(Rr.getDefaults(), Object.keys(Sr.getDefaults())), {
                        filterEnvelope: {
                            attack: .01,
                            decay: 0,
                            sustain: 1,
                    ...
                    voice1: li(di(Rr.getDefaults(), Object.keys(Sr.getDefaults())), {
                        filterEnvelope: {
                            attack: .01,
                            decay: 0,
                            sustain: 1,
        ...
        class Ir extends Cr {
            constructor() {
                ...
                super(t), this.name = "FMSynth", this.modulationIndex = new $o({
                    context: this.context,
                    value: t.modulationIndex
        ...
        class Vr extends Sr {
            constructor() {
                ...
                super(t), this.name = "MetalSynth", this._oscillators = [], this._freqMultipliers = [], this.detune = new po({
                    context: this.context,
                    units: "cents",
                    value: t.detune
                }), this.frequency = new po({
        ...
        class Nr extends Ar {
            ...
            static getDefaults() {
                return li(Sr.getDefaults(), Ar.getDefaults(), {
                    envelope: {
                        attack: .001,
        ...
        si([cr(0)], Nr.prototype, "octaves", void 0), si([hr(0)], Nr.prototype, "pitchDecay", void 0);
        class Pr extends Tr {
            constructor() {
                const t = ui(Pr.getDefaults(), arguments);
                super(t), this.name = "NoiseSynth", this.noise = new zo(Object.assign({
                    context: this.context
            ...
            static getDefaults() {
                return Object.assign(Tr.getDefaults(), {
                    ...
                    noise: Object.assign(di(zo.getDefaults(), Object.keys(jo.getDefaults())), {
                        type: "white"
                    })
                })
            }
        ...
        class Ur extends Wr {
            constructor() {
                ...
                super(t), this.name = "FeedbackCombFilter", this.input = new ho({
                    context: this.context
                }), this.output = new ho({
                    context: this.context
        ...
        class Gr extends io {
            constructor() {
                ...
                super(t), this.name = "OnePoleFilter", this._frequency = t.frequency, this._type = t.type, this.input = new ho({
                    context: this.context
                }), this.output = new ho({
                    context: this.context
                }), this._createFilter()
        ...
        class Qr extends io {
            constructor() {
                ...
                super(t), this.name = "LowpassCombFilter", this._combFilter = this.output = new Ur({
                    context: this.context,
        ...
        class Zr extends Tr {
            constructor() {
                ...
                super(t), this.name = "PluckSynth", this._noise = new zo({
                    context: this.context,
                    type: "pink"
        ...
        class Xr extends Tr {
            constructor() {
                ...
                super(t), this.name = "PolySynth", this._availableVoices = [], this._activeVoices = [], this._voices = [], this._gcTimeout = -1, this._averageActiveVoices = 0, this._syncedRelease = t => this.releaseAll(t), Bn(!Nn(t.voice), "DEPRECATED: The polyphony count is no longer the first argument.");
            ...
            _triggerAttack(t, e, s) {
                t.forEach((t => {
                    const n = new ko(this.context, t).toMidi(),
            ...
            _triggerRelease(t, e) {
                t.forEach((t => {
                    const s = new ko(this.context, t).toMidi(),
        ...
        si([hr(0)], Yr.prototype, "attack", void 0), si([hr(0)], Yr.prototype, "release", void 0);
        class $r extends eo {
            constructor() {
                ...
                this._state.forEachFrom(t, (t => {
                    ...
                    if ("started" === t.state) {
                        ...
                        if (!0 === this._loop || Nn(this._loop) && this._loop > 1) {
                            ...
                            null !== n && (e = Math.min(e, n.time - s)), e !== 1 / 0 && (e = new Co(this.context, e));
        ...
        class Hr extends eo {
            constructor() {
                ...
                super(t), this.name = "Loop", this._event = new $r({
                    context: this.context,
                    callback: this._tick.bind(this),
                    loop: !0,
                    loopEnd: t.interval,
        ...
        class Jr extends $r {
            constructor() {
                ...
                super(t), this.name = "Part", this._state = new so("stopped"), this._events = new Set, this._state.increasing = !0, t.events.forEach((t => {
            ...
            _startNote(t, e, s) {
                e -= s, this._loop ? t.startOffset >= this._loopStart && t.startOffset < this._loopEnd ? (t.startOffset < s && (e += this._getLoopDuration()), t.start(new Co(this.context, e))) : t.startOffset < this._loopStart && t.startOffset >= s && (t.loop = !1, t.start(new Co(this.context, e))) : t.startOffset >= s && t.start(new Co(this.context, e))
            }
            get startOffset() {
                return this._startOffset
            }
            ...
            at(t, e) {
                const s = new Ki(this.context, t).toTicks(),
                    n = new Co(this.context, 1).toSeconds(),
                    i = this._events.values();
                let o = i.next();
                for (; !o.done;) {
                    const t = o.value;
                    if (Math.abs(s - t.startOffset) < n) return Fn(e) && (t.value = e), t;
                    o = i.next()
                }
                return Fn(e) ? (this.add(t, e), this.at(t)) : null
            }
            add(t, e) {
            ...
            remove(t, e) {
                return Pn(t) && t.hasOwnProperty("time") && (t = (e = t).time), t = this.toTicks(t), this._events.forEach((s => {
                    s.startOffset === t && (In(e) || Fn(e) && s.value === e) && (this._events.delete(s), s.dispose())
                })), this
            }
            clear() {
        ...
        function* Kr(t) {
            let e = 0;
            for (; e < t;) e = xi(e, 0, t - 1), yield e, e++
        }

        function* ta(t) {
            let e = t - 1;
            for (; e >= 0;) e = xi(e, 0, t - 1), yield e, e--
        }
        ...
        function* sa(t, e) {
            let s = e ? 0 : t - 1;
            for (;;) s = xi(s, 0, t - 1), yield s, e ? (s++, s >= t - 1 && (e = !1)) : (s--, s <= 0 && (e = !0))
        }
            ...
            switch (Bn(t >= 1, "The number of values must be at least one"), e) {
                ...
                case "randomWalk":
                    yield* function*(t) {
                        ...
                        for (;;) 0 === e ? e++ : e === t - 1 || Math.random() < .5 ? e-- : e++, yield e
                    }(t)
            }
        }
        class aa extends Hr {
        ...
        class ha extends io {
            constructor() {
                ...
                super(t), this.name = "CrossFade", this._panner = this.context.createStereoPanner(), this._split = this.context.createChannelSplitter(2), this._g2a = new fr({
                    context: this.context
                }), this.a = new ho({
                    context: this.context,
                    gain: 0
        ...
        class la extends io {
            constructor(t) {
                super(t), this.name = "Effect", this._dryWet = new ha({
                    context: this.context
                    ...
                    context: this.context
                }), this.output = this._dryWet, this.input.fan(this._dryWet.a, this.effectSend), this.effectReturn.connect(this._dryWet.b), this.wet.setValueAtTime(t.wet, 0), this._internalChannels = [this.effectReturn, this.effectSend], Di(this, "wet")
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    wet: 1
        ...
        class ua extends la {
            constructor(t) {
                super(t), this.name = "LFOEffect", this._lfo = new ar({
                    context: this.context,
                    frequency: t.frequency,
                    amplitude: t.depth
                }), this.depth = this._lfo.amplitude, this.frequency = this._lfo.frequency, this.type = t.type, Di(this, ["frequency", "depth"])
            }
            static getDefaults() {
        ...
        class pa extends ua {
            constructor() {
                ...
                super(t), this.name = "AutoFilter", this.filter = new Mr(Object.assign(t.filter, {
                    context: this.context
        ...
        class da extends io {
            constructor() {
                ...
                super(t), this.name = "Panner", this._panner = this.context.createStereoPanner(), this.input = this._panner, this.output = this._panner, this.pan = new no({
                    context: this.context,
                    param: this._panner.pan,
                    value: t.pan,
                    minValue: -1,
                    maxValue: 1
                }), this._panner.channelCount = t.channelCount, this._panner.channelCountMode = "explicit", Di(this, "pan")
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    pan: 0,
        ...
        class fa extends ua {
            constructor() {
                ...
                super(t), this.name = "AutoPanner", this._panner = new da({
                    context: this.context,
        ...
        class _a extends io {
            constructor() {
                ...
                super(t), this.name = "Follower", this._abs = this.input = new dr({
                    context: this.context
        ...
        class ma extends la {
            constructor() {
                ...
                super(t), this.name = "AutoWah", this._follower = new _a({
                    context: this.context,
                    ...
                    max: 1,
                    exponent: .5
                }), this._baseFrequency = this.toFrequency(t.baseFrequency), this._octaves = t.octaves, this._inputBoost = new ho({
                    context: this.context
        ...
        class va extends la {
            constructor() {
                ...
                super(t), this.name = "BitCrusher", this._bitCrusherWorklet = new ya({
                    context: this.context,
                    bits: t.bits
        ...
        class ya extends Wr {
            constructor() {
                ...
                super(t), this.name = "BitCrusherWorklet", this.input = new ho({
                    context: this.context
                }), this.output = new ho({
                    context: this.context
                }), this.bits = new no({
        ...
        class xa extends la {
            constructor() {
                ...
                super(t), this.name = "Chebyshev", this._shaper = new Io({
                    context: this.context,
                    length: 4096
        ...
        class Ta extends io {
            constructor(t) {
                super(t), this.name = "StereoEffect", this.input = new ho({
                    context: this.context
                }), this.input.channelCount = 2, this.input.channelCountMode = "explicit", this._dryWet = this.output = new ha({
                    context: this.context,
                    fade: t.wet
                }), this.wet = this._dryWet.fade, this._split = new wa({
                    context: this.context,
                    channels: 2
                }), this._merge = new ba({
                    context: this.context,
                    channels: 2
                }), this.input.connect(this._split), this.input.connect(this._dryWet.a), this._merge.connect(this._dryWet.b), Di(this, ["wet"])
            }
            connectEffectLeft(...t) {
        ...
        class Sa extends Ta {
            constructor(t) {
                super(t), this.feedback = new po({
                    ...
                    context: this.context
                }), this._feedbackSplit = new wa({
                    context: this.context,
                    channels: 2
                }), this._feedbackMerge = new ba({
                    context: this.context,
                    channels: 2
        ...
        class ka extends Sa {
            constructor() {
                ...
                super(t), this.name = "Chorus", this._depth = t.depth, this._delayTime = t.delayTime / 1e3, this._lfoL = new ar({
                    context: this.context,
                    frequency: t.frequency,
                    min: 0,
                    max: 1
        ...
        class Aa extends la {
            constructor() {
                ...
                super(t), this.name = "Distortion", this._shaper = new Io({
                    context: this.context,
                    length: 4096
        ...
        class Ca extends la {
            constructor(t) {
                super(t), this.name = "FeedbackEffect", this._feedbackGain = new ho({
                    context: this.context,
                    gain: t.feedback,
                    units: "normalRange"
                }), this.feedback = this._feedbackGain.gain, Di(this, "feedback"), this.effectReturn.chain(this._feedbackGain, this.effectSend)
            }
            static getDefaults() {
                return Object.assign(la.getDefaults(), {
                    feedback: .125
        ...
        class Oa extends Ca {
            constructor() {
                ...
                super(t), this.name = "FeedbackDelay", this._delayNode = new yo({
                    context: this.context,
                    delayTime: t.delayTime,
                    maxDelay: t.maxDelay
                }), this.delayTime = this._delayNode.delayTime, this.connectEffect(this._delayNode), Di(this, "delayTime")
            }
            static getDefaults() {
        ...
        class Da extends io {
            constructor(t) {
                super(t), this.name = "PhaseShiftAllpass", this.input = new ho({
                    context: this.context
                }), this.output = new ho({
                    context: this.context
        ...
        class Ma extends la {
            constructor() {
                ...
                super(t), this.name = "FrequencyShifter", this.frequency = new po({
                    context: this.context,
                    units: "frequency",
                    value: t.frequency,
                    ...
                    phase: -90,
                    type: "sine"
                }), this._sineMultiply = new $o({
                    context: this.context
                }), this._cosineMultiply = new $o({
                    context: this.context
                }), this._negate = new _r({
                    context: this.context
                }), this._add = new ir({
        ...
        const Ea = [1557 / 44100, 1617 / 44100, 1491 / 44100, 1422 / 44100, 1277 / 44100, 1356 / 44100, 1188 / 44100, 1116 / 44100],
            Ra = [225, 556, 441, 341];
        class qa extends Ta {
            constructor() {
                const t = ui(qa.getDefaults(), arguments, ["roomSize", "dampening"]);
                super(t), this.name = "Freeverb", this._combFilters = [], this._allpassFiltersL = [], this._allpassFiltersR = [], this.roomSize = new po({
                    context: this.context,
                    value: t.roomSize,
                    units: "normalRange"
                }), this._allpassFiltersL = Ra.map((t => {
        ...
        const Ia = [.06748, .06404, .08212, .09004],
            Fa = [.773, .802, .753, .733],
            Va = [347, 113, 37];
        class Na extends Ta {
            constructor() {
                const t = ui(Na.getDefaults(), arguments, ["roomSize"]);
                super(t), this.name = "JCReverb", this._allpassFilters = [], this._feedbackCombFilters = [], this.roomSize = new po({
                    context: this.context,
                    value: t.roomSize,
                    units: "normalRange"
                }), this._scaleRoomSize = new or({
                    context: this.context,
                    min: -.733,
                    max: .197
                }), this._allpassFilters = Va.map((t => {
                    const e = this.context.createBiquadFilter();
                    return e.type = "allpass", e.frequency.value = t, e
        ...
        class ja extends Pa {
            constructor() {
                ...
                super(t), this.name = "PingPongDelay", this._leftDelay = new yo({
                    context: this.context,
                    maxDelay: t.maxDelay
                    ...
                    units: "time",
                    value: t.delayTime
                }), this.connectEffectLeft(this._leftDelay), this.connectEffectRight(this._rightPreDelay, this._rightDelay), this.delayTime.fan(this._leftDelay.delayTime, this._rightDelay.delayTime, this._rightPreDelay.delayTime), this._feedbackL.disconnect(), this._feedbackL.connect(this._rightDelay), Di(this, ["delayTime"])
            }
            static getDefaults() {
        ...
        class La extends Ca {
            constructor() {
                ...
                super(t), this.name = "PitchShift", this._frequency = new po({
                    context: this.context
                }), this._delayA = new yo({
                    maxDelay: 1,
                    context: this.context
                    ...
                    type: "sawtooth",
                    phase: 180
                }).connect(this._delayB.delayTime), this._crossFade = new ha({
                    context: this.context
                }), this._crossFadeLFO = new ar({
                    context: this.context,
                    min: 0,
                    max: 1,
                    type: "triangle",
                    ...
                    delayTime: t.delayTime,
                    context: this.context
                }), this.delayTime = this._feedbackDelay.delayTime, Di(this, "delayTime"), this._pitch = t.pitch, this._windowSize = t.windowSize, this._delayA.connect(this._crossFade.a), this._delayB.connect(this._crossFade.b), this._frequency.fan(this._lfoA.frequency, this._lfoB.frequency, this._crossFadeLFO.frequency), this.effectSend.fan(this._delayA, this._delayB), this._crossFade.chain(this._feedbackDelay, this.effectReturn);
                const e = this.now();
        ...
        class za extends Ta {
            constructor() {
                ...
                super(t), this.name = "Phaser", this._lfoL = new ar({
                    context: this.context,
                    frequency: t.frequency,
                    min: 0,
                    max: 1
                    ...
                    max: 1,
                    phase: 180
                }), this._baseFrequency = this.toFrequency(t.baseFrequency), this._octaves = t.octaves, this.Q = new po({
                    context: this.context,
                    value: t.Q,
                    units: "positive"
        ...
        class Wa extends la {
            constructor() {
                ...
                Un(e, .001), this._decay = e;
                const s = this.toSeconds(t.preDelay);
                Un(s, 0), this._preDelay = s, this.generate(), this.connectEffect(this._convolver)
            }
            static getDefaults() {
                return Object.assign(la.getDefaults(), {
                    decay: 1.5,
            ...
            set decay(t) {
                Un(t = this.toSeconds(t), .001), this._decay = t, this.generate()
            }
            get preDelay() {
        ...
        class Ba extends io {
            constructor() {
                super(ui(Ba.getDefaults(), arguments)), this.name = "MidSideSplit", this._split = this.input = new wa({
                    channels: 2,
                    context: this.context
                }), this._midAdd = new ir({
                    context: this.context
        ...
        class Ua extends io {
            constructor() {
                super(ui(Ua.getDefaults(), arguments)), this.name = "MidSideMerge", this.mid = new ho({
                    context: this.context
                }), this.side = new ho({
                    context: this.context
                }), this._left = new ir({
                    context: this.context
                }), this._leftMult = new $o({
                    context: this.context,
                    value: Math.SQRT1_2
                }), this._right = new mr({
                    context: this.context
                }), this._rightMult = new $o({
                    context: this.context,
                    value: Math.SQRT1_2
                }), this._merge = this.output = new ba({
                    context: this.context
        ...
        class Ga extends la {
            constructor(t) {
                super(t), this.name = "MidSideEffect", this._midSideMerge = new Ua({
                    context: this.context
                }), this._midSideSplit = new Ba({
                    context: this.context
        ...
        class Qa extends Ga {
            constructor() {
                ...
                super(t), this.name = "StereoWidener", this.width = new po({
                    context: this.context,
                    value: t.width,
                    units: "normalRange"
                }), Di(this, ["width"]), this._twoTimesWidthMid = new $o({
                    context: this.context,
                    value: 2
                }), this._twoTimesWidthSide = new $o({
                    context: this.context,
                    value: 2
                }), this._midMult = new $o({
                    context: this.context
                }), this._twoTimesWidthMid.connect(this._midMult.factor), this.connectEffectMid(this._midMult), this._oneMinusWidth = new mr({
                    context: this.context
                }), this._oneMinusWidth.connect(this._twoTimesWidthMid), ro(this.context.getConstant(1), this._oneMinusWidth), this.width.connect(this._oneMinusWidth.subtrahend), this._sideMult = new $o({
                    context: this.context
            ...
            static getDefaults() {
                return Object.assign(Ga.getDefaults(), {
                    width: .5
                })
            }
            dispose() {
        ...
        class Za extends Ta {
            constructor() {
                ...
                super(t), this.name = "Tremolo", this._lfoL = new ar({
                    context: this.context,
                    type: t.type,
                    min: 1,
                    max: 0
                    ...
                    value: t.depth,
                    units: "normalRange"
                }), Di(this, ["frequency", "depth"]), this.connectEffectLeft(this._amplitudeL), this.connectEffectRight(this._amplitudeR), this._lfoL.connect(this._amplitudeL.gain), this._lfoR.connect(this._amplitudeR.gain), this.frequency.fan(this._lfoL.frequency, this._lfoR.frequency), this.depth.fan(this._lfoR.amplitude, this._lfoL.amplitude), this.spread = t.spread
            }
            static getDefaults() {
                return Object.assign(Ta.getDefaults(), {
                    frequency: 10,
        ...
        class Xa extends la {
            constructor() {
                ...
                super(t), this.name = "Vibrato", this._delayNode = new yo({
                    context: this.context,
                    delayTime: 0,
                    maxDelay: t.maxDelay
                }), this._lfo = new ar({
                    ...
                    frequency: t.frequency,
                    phase: -90
                }).start().connect(this._delayNode.delayTime), this.frequency = this._lfo.frequency, this.depth = this._lfo.amplitude, this.depth.value = t.depth, Di(this, ["frequency", "depth"]), this.effectSend.chain(this._delayNode, this.effectReturn)
            }
            static getDefaults() {
                return Object.assign(la.getDefaults(), {
                    maxDelay: .005,
        ...
        class Ya extends io {
            constructor() {
                ...
                super(t), this.name = "Analyser", this._analysers = [], this._buffers = [], this.input = this.output = this._gain = new ho({
                    context: this.context
                }), this._split = new wa({
                    context: this.context,
                    channels: t.channels
        ...
        class $a extends io {
            constructor() {
                super(ui($a.getDefaults(), arguments)), this.name = "MeterBase", this.input = this.output = this._analyser = new Ya({
                    context: this.context,
                    size: 256,
                    type: "waveform"
                })
        ...
        class Ha extends $a {
            constructor() {
                ...
                super(t), this.name = "Meter", this.input = this.output = this._analyser = new Ya({
                    context: this.context,
                    size: 256,
                    type: "waveform",
            ...
            static getDefaults() {
                return Object.assign($a.getDefaults(), {
                    smoothing: .8,
                    normalRange: !1,
                    channelCount: 1
                })
        ...
        class ec extends io {
            constructor() {
                ...
                super(t), this.name = "Solo", this.input = this.output = new ho({
                    context: this.context
                }), ec._allSolos.has(this.context) || ec._allSolos.set(this.context, new Set), ec._allSolos.get(this.context).add(this), this.solo = t.solo
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    solo: !1
        ...
        class sc extends io {
            constructor() {
                ...
                super(t), this.name = "PanVol", this._panner = this.input = new da({
                    context: this.context,
                    pan: t.pan,
                    channelCount: t.channelCount
                }), this.pan = this._panner.pan, this._volume = this.output = new xo({
                    context: this.context,
                    volume: t.volume
                }), this.volume = this._volume.volume, this._panner.connect(this._volume), this.mute = t.mute, Di(this, ["pan", "volume"])
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    mute: !1,
        ...
        class nc extends io {
            constructor() {
                ...
                super(t), this.name = "Channel", this._solo = this.input = new ec({
                    solo: t.solo,
                    context: this.context
                }), this._panVol = this.output = new sc({
                    context: this.context,
                    pan: t.pan,
                    volume: t.volume,
                    mute: t.mute,
                    channelCount: t.channelCount
                }), this.pan = this._panVol.pan, this.volume = this._panVol.volume, this._solo.connect(this._panVol), Di(this, ["pan", "volume"])
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    pan: 0,
            ...
            _getBus(t) {
                return nc.buses.has(t) || nc.buses.set(t, new ho({
                    context: this.context
                })), nc.buses.get(t)
            }
            send(t, e = 0) {
        ...
        class ic extends io {
            constructor() {
                super(ui(ic.getDefaults(), arguments)), this.name = "Mono", this.input = new ho({
                    context: this.context
                }), this._merge = this.output = new ba({
                    channels: 2,
                    context: this.context
        ...
        class oc extends io {
            constructor() {
                ...
                super(t), this.name = "MultibandSplit", this.input = new ho({
                    context: this.context
                    ...
                    frequency: 0,
                    type: "highpass"
                }), this._internalChannels = [this.low, this.mid, this.high], this.lowFrequency = new po({
                    context: this.context,
                    units: "frequency",
        ...
        class ac extends io {
            constructor() {
                ...
                super(t), this.name = "Recorder", this.input = new ho({
                    context: this.context
            ...
            start() {
                return ni(this, void 0, void 0, (function*() {
                    ...
                    return "stopped" === this.state ? this._recorder.start() : this._recorder.resume(), yield t
                }))
            }
            stop() {
                return ni(this, void 0, void 0, (function*() {
        ...
        class cc extends io {
            constructor() {
                ...
                super(t), this.name = "Compressor", this._compressor = this.context.createDynamicsCompressor(), this.input = this._compressor, this.output = this._compressor, this.threshold = new no({
                    ...
                    units: "positive",
                    value: t.ratio
                }), Di(this, ["knee", "release", "attack", "ratio", "threshold"])
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    attack: .003,
        ...
        class hc extends io {
            constructor() {
                ...
                super(t), this.name = "Gate", this._follower = new _a({
                    context: this.context,
        ...
        class lc extends io {
            constructor() {
                ...
                super(t), this.name = "Limiter", this._compressor = this.input = this.output = new cc({
                    context: this.context,
                    ratio: 20,
                    attack: .003,
                    release: .01,
                    threshold: t.threshold
                }), this.threshold = this._compressor.threshold, Di(this, "threshold")
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    threshold: -12
        ...
        class uc extends io {
            constructor() {
                ...
                super(t), this.name = "MidSideCompressor", this._midSideSplit = this.input = new Ba({
                    context: this.context
                }), this._midSideMerge = this.output = new Ua({
                    context: this.context
                }), this.mid = new cc(Object.assign(t.mid, {
                    context: this.context
                })), this.side = new cc(Object.assign(t.side, {
                    context: this.context
                })), this._midSideSplit.mid.chain(this.mid, this._midSideMerge.mid), this._midSideSplit.side.chain(this.side, this._midSideMerge.side), Di(this, ["mid", "side"])
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    mid: {
        ...
        class pc extends io {
            constructor() {
                ...
                super(t), this.name = "MultibandCompressor", this._splitter = this.input = new oc({
                    context: this.context,
                    ...
                    context: this.context
                })), this._splitter.low.chain(this.low, this.output), this._splitter.mid.chain(this.mid, this.output), this._splitter.high.chain(this.high, this.output), Di(this, ["high", "mid", "low", "highFrequency", "lowFrequency"])
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    lowFrequency: 250,
        ...
        class dc extends io {
            constructor() {
                ...
                super(t), this.name = "EQ3", this.output = new ho({
                    context: this.context
                }), this._internalChannels = [], this.input = this._multibandSplit = new oc({
                    context: this.context,
                    highFrequency: t.highFrequency,
                    lowFrequency: t.lowFrequency
                    ...
                    gain: t.high,
                    units: "decibels"
                }), this.low = this._lowGain.gain, this.mid = this._midGain.gain, this.high = this._highGain.gain, this.Q = this._multibandSplit.Q, this.lowFrequency = this._multibandSplit.lowFrequency, this.highFrequency = this._multibandSplit.highFrequency, this._multibandSplit.low.chain(this._lowGain, this.output), this._multibandSplit.mid.chain(this._midGain, this.output), this._multibandSplit.high.chain(this._highGain, this.output), Di(this, ["low", "mid", "high", "lowFrequency", "highFrequency"]), this._internalChannels = [this._multibandSplit]
            }
            static getDefaults() {
                return Object.assign(io.getDefaults(), {
                    high: 0,
