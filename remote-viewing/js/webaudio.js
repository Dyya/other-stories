...
class WebAudio
{
    ...
    createAudioParamInPort(op, portName, audioNode, options, defaultValue)
    {
        ...
        const port = op.inDynamic(
            portName,
            [external_CABLES_namespaceObject.CONSTANTS.OP.OP_PORT_TYPE_VALUE, external_CABLES_namespaceObject.CONSTANTS.OP.OP_PORT_TYPE_OBJECT],
            options,
            defaultValue,
        );
        port.webAudio = {};
